...
BACKGROUNDS = [
    ...
    {"id": "star", "name": "유명 가수",
     ...
     "fame": 55, "money": 3000, "start_age": 26},
    {"id": "producer", "name": "신인 프로듀서",
     ...
     "fame": 10, "money": 1200, "start_age": 25},
    ...
    {"id": "trainee", "name": "연습생",
     ...
     "fame": 15, "money": 300, "start_age": 18},
    {"id": "indie", "name": "인디 뮤지션",
     ...
     "fame": 12, "money": 500, "start_age": 24},
    {"id": "ceo_small", "name": "신생 기획사 대표",
     ...
     "fame": 20, "money": 5000, "start_age": 34},
    {"id": "ceo_big", "name": "대형 기획사 대표",
     ...
     "fame": 45, "money": 30000, "start_age": 45},
]
